...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private NetworkBool _jump;
        private NetworkBool _sprint;
        ...
        private void Start()
        {
            ...
            isLocalPlayer = FusionConnection.Instance.runner.LocalPlayer;

            if (isLocalPlayer)
            {
                FootstepAudioClips = Resources.LoadAll<AudioClip>("FootStepSFX");
                LandingAudioClip = Resources.Load<AudioClip>("LandSFX/Player_Land");
            }
        ...
        public void SetInput(PlayerInputData data)
        {
            // Replace old "_input" with direct values from Fusion input
            _move = data.Move;
            _look = data.Look;
            _jump = data.Jump;
            _sprint = data.Sprint;
            _analogMovement = data.AnalogMovement;
        }
